export declare namespace Transport {
    ...
    export class Car extends Vehicle implements ICar {
        private _bodyType;
        private _carType;
        constructor(make: string, model: string, year: number, vin: string, registrationNumber: string, owner: IOwner, bodyType: CarBody, carType: CarType);
        get bodyType(): CarBody;
        set bodyType(bodyType: CarBody);
        get carType(): CarType;
